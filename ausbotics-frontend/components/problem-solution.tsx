  ...
  const problems = [
    {
      ...
      description: "Businesses lose potential customers when calls go unanswered during off-hours or peak times.",
    },
    {
      icon: TrendingUp,
      title: "Rising Costs",
      description: "Traditional call centers are expensive to maintain and scale, especially for growing businesses.",
    },
    {
      icon: CheckCircle,
      title: "Inconsistent Service",
      description: "Human agents vary in performance, leading to inconsistent customer experiences and outcomes.",
    },
  ]
    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">The Challenge Businesses Face</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Modern businesses struggle with customer communication challenges that impact growth and customer
            satisfaction.
          </p>
        </div>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            AI calling agents that solve these challenges while delivering superior customer experiences.
          </p>
        </div>
